    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                //my recipes
                createShaped(RecipeCategory.MISC, ModBlocks.TEST_BLOCK)
                        .pattern("RRR")
                        .pattern("RRR")
                        .pattern("RRR")
                        .input('R', ModItems.TEST_ITEM)
                        .criterion(hasItem(ModItems.TEST_ITEM), conditionsFromItem(ModItems.TEST_ITEM))
                        .offerTo(exporter);

                createShapeless(RecipeCategory.MISC, ModItems.TEST_ITEM, 9)
