...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.TEST_ORE, oreDrops(ModBlocks.TEST_ORE, ModItems.TEST_ITEM));
        addDrop(ModBlocks.TEST_DEEPSLATE_ORE, multipleOreDrops(ModBlocks.TEST_DEEPSLATE_ORE, ModItems.TEST_ITEM, 10, 50));
